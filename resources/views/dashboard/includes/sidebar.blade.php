        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item">
                     ...
                     <ul class="menu-content">
                            ...
                            <li><a class="menu-item" href="" data-i18n="nav.dash.crypto">اضافة لغة جديدة</a></li>
                     </ul>
            </li>
            ...
            <li class="nav-item">
                     ...
                     <ul class="menu-content">
                            <li class="active"><a class="menu-item" href="{{route('main_categories.index')}}" data-i18n="nav.dash.ecommerce"> عرض الكل </a></li>
                            <li><a class="menu-item" href="{{route('main_categories.create')}}" data-i18n="nav.dash.crypto">أضافة قسم جديد </a></li>
                     </ul>
            </li>
            ...
            <li class="nav-item">
                     ...
                     <ul class="menu-content">
                            <li class="active"><a class="menu-item" href="{{route('sub_categories.index')}}" data-i18n="nav.dash.ecommerce"> عرض الكل </a></li>
                            <li><a class="menu-item" href="{{route('sub_categories.create')}}" data-i18n="nav.dash.crypto">أضافة قسم جديد </a></li>
                     </ul>
            </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-male"></i>
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="{{route('brands.create')}}" data-i18n="nav.dash.crypto"> أضافة ماركة جديده</a>
                    </li>
                </ul>
            </li>
            ...
            <li class=" nav-item"><a href="#"><i class="la la-television"></i><span class="menu-title" data-i18n="nav.templates.main"> الاعدادات</span></a>
                <ul class="menu-content">
                    <li><a class="menu-item" href="#" data-i18n="nav.templates.vert.main">وسائل التوصيل</a>
                        <ul class="menu-content">
                            <li><a class="menu-item" href="{{route('edit.shipping.methods',['type' => 'free'])}}"
                                   data-i18n="nav.templates.vert.classic_menu">توصيل مجانى</a>
                            </li>
                            <li><a class="menu-item" href="{{route('edit.shipping.methods',['type' => 'local'])}}">توصيل داخلى</a>
                            </li>
                            <li><a class="menu-item" href="{{route('edit.shipping.methods',['type' => 'outer'])}}"
